                                ...
                                <tr>
                                  ...
                                  <td colspan="3">
                                    <select name="" id="jenis" class="form-control" style="margin: 5px">
                                      ...
                                      <option value="3">Timbangan (Belum Packing)</option>
                                    </select>
...
<script>
   ...
   function cetak(ctk){
    ...
    if (jenis == "") {
      showNotification("alert-info", "Silahkan Pilih Jenis Laporan", "bottom", "right", "", ""); return;
    }
    ...
    var url    = "<?php echo base_url('Laporan/Laporan?'); ?>";
